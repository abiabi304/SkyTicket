...
const navItems: Array<{ href: string; label: string; icon: typeof Home; matchPrefix?: string; neverActive?: boolean }> = [
  { href: '/', label: 'Beranda', icon: Home },
  { href: '/#search', label: 'Cari', icon: Search, neverActive: true },
